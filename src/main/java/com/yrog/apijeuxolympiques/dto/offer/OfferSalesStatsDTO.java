...
@Getter
@Setter
@Schema(description = "Détails enrichis d'une offre avec le nombre de ventes par offre")
public class OfferSalesStatsDTO {
    ...
    @Schema(description = "Nombre de ventes par offre", example = "352")
    private Integer salesCount;

    public OfferSalesStatsDTO() {}
}